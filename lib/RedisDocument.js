...
var getDeepProperty = require('camfou-modinha').getDeepProperty
...
RedisDocument.list = function (options, callback) {
  ...
  var size = Number(options.size) || 50
...
RedisDocument.enforceUnique = function (data, callback) {
  ...
  Object.keys(schema).forEach(function (key) {
    ...
    if (Object.prototype.hasOwnProperty.call(data, key) && property && property.unique) {
      checksPromises.push(Promise.resolve()
        .then(() => {
          ...
          return new Promise((resolve, reject) => {
            Model[method](data[key], function (err, instance) {
              ...
              if (instance && instance._id !== data._id) {
                reject(new UniqueValueError(key))
              }
              resolve(null)
            })
          })
